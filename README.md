...
Проверка сформированных автором тестов, дала данные, что при увеличении количества вершин и ребер, прямопропорционально увеличивается и время работы данного алгоритма.
Соответственно предполагаем, что общая алгоритмическая сложность алгоритма есть O(V + E), где V — количество вершин, а E — количество ребер.

<p align="center">
<image
  src="/images/ГРАФИК.png"
  alt="2"
  style="width: 450px;">
  <p align="center">Зависимость времени от суммы вершин с ребрами</p>
</p>
