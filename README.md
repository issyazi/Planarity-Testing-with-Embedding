...
# Глоссарий
-Визуализатор - программа, которая берет данные из определенного источника и превращает их в визуальный контент
...
Для проверки корректности работы алгоритма, используется визуализатор написанный через graphviz на языке DOT. Задача визуализирующей программы показать, возможна ли укладка планарного графа на основе входных граней.
...
Так как алгоритм работает с ребрами и вершинами данного на входе графа, то общая алгоритмическая сложность алгоритма O(V + E), где V — количество вершин, а E — количество ребер.
