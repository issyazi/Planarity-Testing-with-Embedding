...
Работа алгоритма начинается с поиска цикла, в котором будет самое наименьшее количество вершин, если таких циклов несколько, то берется первый найденный, который ещё не уложен на плоскости.
